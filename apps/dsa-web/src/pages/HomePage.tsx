  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col min-h-0 min-w-0 max-w-full lg:max-w-6xl mx-auto w-full">
        <div className="flex flex-shrink-0 justify-center px-3 pt-4 md:px-4 md:pt-6">
          <h1 className="text-center text-4xl font-bold tracking-normal text-foreground md:text-6xl">
            东莞炒股王
          </h1>
        </div>
